...
class AlignSubNet(nn.Module):
    def __init__(self, args, mode):
        ...
        in_dim_t, in_dim_v, in_dim_a = args.text_feat_dim, args.img_feat_dim, args.cap_feat_dim

        seq_len_t, seq_len_v, seq_len_a = args.max_cons_seq_length, args.img_seq_len, args.cap_seq_len
